...
const GAME_EMBLEM = {
	...
	// THE BOARD, WITH ONE CARD TURNED — four cells, three open and one contacted.
	// Drawn as a quadrant rather than as the real 5x5 for the reason the family
	// rules already give: these render at 27px on a home card and 20px in the
	// lobby band, and a 5x5 of 1.5-stroke lines is 24 hairlines ~1.4px apart,
	// i.e. grey mush. Four cells of 6.4 units carry the same idea at any size.
	// It is deliberately NOT a fifth rounded card/box (Dontminion's chest,
